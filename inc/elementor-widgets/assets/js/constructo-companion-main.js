(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".constructo-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".constructo-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".constructo-team-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.constructo-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.constructo-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $('.constructo-subscribe-newsletter-area');
    if ($subscribe.length) {
