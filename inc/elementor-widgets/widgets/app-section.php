...
/**
 *
 * Constructo elementor app section widget.
 *
 * @since 1.0
 */
class Constructo_App_Section extends Widget_Base {

	public function get_name() {
		return 'constructo-app-section';
	}

	public function get_title() {
		return __( 'App Section', 'constructo-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'apps_content',
            [
                'label' => __( 'App Section Settings', 'constructo-companion' ),
            ]
        );
        $this->add_control(
            'sec_img',
            [
                'label' => esc_html__( 'Section Image', 'constructo-companion' ),
                'description' => esc_html__( 'Best size is 1920x456', 'constructo-companion' ),
        ...
        $this->add_control(
            'ios_url',
            [
                'label' => esc_html__( 'IOS App URL', 'constructo-companion' ),
        ...
        $this->add_control(
            'android_url',
            [
                'label' => esc_html__( 'Android App URL', 'constructo-companion' ),
                'type' => Controls_Manager::URL,
                'label_block' => true,
                'default'   => [
                    'url' => '#'
    ...
    public function constructo_left_contents( $sec_title, $sec_text, $btn_label, $btn_url, $style_type ) {
    ...
    public function constructo_right_contents( $sec_img, $style_type ) {
    ...
    $ios_app_path = CONSTRUCTO_DIR_ICON_IMG_URI . 'ios-app.svg';
    $android_app_path = CONSTRUCTO_DIR_ICON_IMG_URI . 'android-app.svg';
    ?>
    
    <!-- productivity_area  -->
    <div class="productivity_area" <?php echo constructo_inline_bg_img( esc_url( $sec_img ) ); ?>>
        <div class="container">
