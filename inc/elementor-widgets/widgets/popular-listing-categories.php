...
/**
 *
 * Constructo elementor Constructo categories section widget.
 *
 * @since 1.0
 */
class Constructo_Listing_Categories extends Widget_Base {

	public function get_name() {
		return 'constructo-listing-categories';
	}

	public function get_title() {
		return __( 'Popular Listing Cat.', 'constructo-companion' );
	}
	...
	protected function _register_controls() {
		...
		// ----------------------------------------  Constructo categories content ------------------------------
		$this->start_controls_section(
			'constructo_content',
			[
				'label' => __( 'Popular Listing Cat. content', 'constructo-companion' ),
			]
        );
        $this->add_control(
            'sub_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Discover', 'constructo-companion' ),
            ]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'Most Popular Categories', 'constructo-companion' ),
            ]
        );
        $this->add_control(
            'selected_cats',
            [
                'label' => esc_html__( 'Select Categories To Show', 'constructo-companion' ),
                'type' => Controls_Manager::SELECT2,
                'label_block' => true,
                'multiple' => true,
                // 'options'   => constructo_get_taxonomies(),
                // 'options'   => [
                //     '1' => 'eita',
                //     '2' => 'oita'
                // ],
		...
		$this->add_control(
			'cat_order',
			[
				'label'         => esc_html__( 'Category Order', 'constructo-companion' ),
		...
		$this->add_control(
			'cat_item',
			[
				'label'         => esc_html__( 'Item To Show', 'constructo-companion' ),
    ...
    // constructo_related_items('', $post_item, $post_order);
    ?>
