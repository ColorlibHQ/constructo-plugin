...
/**
 *
 * Constructo Team Members Contents section widget.
 *
 * @since 1.0
 */
class Constructo_Team_Members extends Widget_Base {

	public function get_name() {
		return 'constructo-team-members-contents';
	}

	public function get_title() {
		return __( 'Team Members', 'constructo-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Team Members Contents', 'constructo-companion' ),
			]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block'   => true,
                'default'       => __( 'Expert Team', 'constructo-companion' )
            ]
        );
		$this->add_control(
            'members', [
                ...
                'fields' => [
                    [
                        'name' => 'member_img',
                        'label' => __( 'Member Image', 'constructo-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'member_name',
                        'label' => __( 'Member Name', 'constructo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Milani Mou', 'constructo-companion' ),
                    ],
                    [
                        'name' => 'designation',
                        'label' => __( 'Member Designation', 'constructo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Photographer', 'constructo-companion' ),
                    ],
                    [
                        'name' => 'fb_url',
                        'label' => __( 'Facebook URL', 'constructo-companion' ),
                        'label_block' => true,
                        ...
                        'name' => 'tw_url',
                        'label' => __( 'Twitter URL', 'constructo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::URL,
                        'default'   => [
                            'url'   => '#',
                        ...
                        'name' => 'ins_url',
                        'label' => __( 'Instagram URL', 'constructo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::URL,
                        'default'   => [
                            'url'   => '#',
                ...
                'default'   => [
                    [
                        ...
                        'member_name'        => __( 'Milani Mou', 'constructo-companion' ),
                        'designation' => __( 'Photographer', 'constructo-companion' ),
                        'fb_url'             => [
                            'url'            => '#',
                        ],
                        'tw_url'             => [
                    ...
                    [
                        ...
                        'member_name'        => __( 'Jasmine Pinky', 'constructo-companion' ),
                        'designation' => __( 'Photographer', 'constructo-companion' ),
                        'fb_url'             => [
                            'url'            => '#',
                        ],
                    ...
                    [
                        ...
                        'member_name'        => __( 'Piya Zosoldos', 'constructo-companion' ),
                        'designation' => __( 'Photographer', 'constructo-companion' ),
                        'fb_url'             => [
                            'url'            => '#',
                        ],
                ...
                <div class="row">
                    ...
                    if( is_array( $members ) && count( $members ) > 0 ){
                        foreach ( $members as $item ) {
                            ...
                            $member_img = !empty( $item['member_img']['id'] ) ? wp_get_attachment_image( $item['member_img']['id'], 'constructo_team_thumb_362x400', '', array('alt' => $member_name . ' image' ) ) : '';
