...
----------------------------------------*/
class constructo_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('constructo_instagram_photo',esc_html__('[ Constructo ] Intagram Photo','constructo-companion'),array(
			'description' => esc_html__('Constructo Instagram Photo Widget','constructo-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'constructo-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'constructo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'constructo-companion'); ?></label>
...
if(!function_exists('constructo_instagram_widgets')):
	function constructo_instagram_widgets(){
		register_widget('constructo_instagram_photo');
	}
	add_action('widgets_init','constructo_instagram_widgets');
endif;
