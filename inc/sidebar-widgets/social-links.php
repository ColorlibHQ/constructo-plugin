...
class Constructo_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'constructo_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Constructo ] Social Links', 'constructo-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'constructo-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'constructo-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'constructo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'constructo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'constructo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'constructo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'constructo-companion'); ?></label>
...
} // Class constructo_social_links ends here


// Register and load the widget
function constructo_social_links_widget_load() {
	register_widget( 'Constructo_social_links' );
}
add_action( 'widgets_init', 'constructo_social_links_widget_load' );